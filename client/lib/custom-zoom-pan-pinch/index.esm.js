...
var ZoomPanPinch = /** @class */ (function () {
    function ZoomPanPinch(props) {
        ...
        this.initializeWindowEvents = function () {
            ...
            var currentDocument = (_a = _this.wrapperComponent) === null || _a === void 0 ? void 0 : _a.getRootNode();
            var pageDocument = (_b = _this.wrapperComponent) === null || _b === void 0 ? void 0 : _b.ownerDocument;
            var currentWindow = pageDocument === null || pageDocument === void 0 ? void 0 : pageDocument.defaultView;
            // Panning on window to allow panning when mouse is out of component wrapper
            currentDocument === null || currentDocument === void 0 ? void 0 : currentDocument.addEventListener("mousedown", _this.onPanningStart, passive);
            currentDocument === null || currentDocument === void 0 ? void 0 : currentDocument.addEventListener("mouseup", _this.onPanningStop, passive);
            currentDocument === null || currentDocument === void 0 ? void 0 : currentDocument.addEventListener("mouseleave", _this.clearPanning, passive);
            document === null || document === void 0 ? void 0 : document.addEventListener("mouseleave", _this.clearPanning, passive);
        ...
        this.cleanupWindowEvents = function () {
            ...
            var pageDocument = (_b = _this.wrapperComponent) === null || _b === void 0 ? void 0 : _b.ownerDocument;
            var currentWindow = pageDocument === null || pageDocument === void 0 ? void 0 : pageDocument.defaultView;
            currentDocument === null || currentDocument === void 0 ? void 0 : currentDocument.removeEventListener("mousedown", _this.onPanningStart, passive);
            currentDocument === null || currentDocument === void 0 ? void 0 : currentDocument.removeEventListener("mouseup", _this.onPanningStop, passive);
            currentDocument === null || currentDocument === void 0 ? void 0 : currentDocument.removeEventListener("mouseleave", _this.clearPanning, passive);
            document === null || document === void 0 ? void 0 : document.removeEventListener("mouseleave", _this.clearPanning, passive);
            currentWindow === null || currentWindow === void 0 ? void 0 : currentWindow.removeEventListener("mousemove", _this.onPanning, passive);
            currentWindow === null || currentWindow === void 0 ? void 0 : currentWindow.removeEventListener("keyup", _this.setKeyUnPressed, passive);
            currentWindow === null || currentWindow === void 0 ? void 0 : currentWindow.removeEventListener("keydown", _this.setKeyPressed, passive);
            handleCancelAnimation(_this);
            (_c = _this.observer) === null || _c === void 0 ? void 0 : _c.disconnect();
        };
