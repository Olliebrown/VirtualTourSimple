    ...
    <Stack spacing={2}>
      ...
      <Stack direction="row" spacing={2}>
        <NumberField
          ...
          value={video.chromaKeyWeights.r}
        ...
        <NumberField
          ...
          value={video.chromaKeyWeights.g}
        ...
        <NumberField
          ...
          value={video.chromaKeyWeights.b}
